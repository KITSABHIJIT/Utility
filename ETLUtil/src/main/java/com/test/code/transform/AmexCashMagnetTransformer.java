...
public class AmexCashMagnetTransformer {
	...
	public static List<Expense> processData(List<Expense> expenseList){
		...
		try
		{
			 ...
			 */
			csvReader = new CSVReader(new FileReader(PropertiesUtil.getProperty("AmexBlueCashFile")),COMMA_DELIMITER,QUOTE_CHAR,1);
			...
			System.err.println("Error file: "+PropertiesUtil.getProperty("AmexBlueCashFile")+"\n Error Data: "+StringUtil.printArray(expenseDetails));
			e.printStackTrace();
		}
		return expenseList;
	}

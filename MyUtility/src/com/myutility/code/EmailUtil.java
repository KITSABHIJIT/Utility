...
, "text/html; charset=utf-8");*/
			...
			messagePart.setContent("<h3>This is a test email.<h3>", "text/html; charset=utf-8");
			...
			if(attachment){
				...
				attachmentPart.setFileName(PropertiesUtil.getProperty("mail.attachmentFileName"));
				multipart.addBodyPart(attachmentPart);
				System.out.println("Attachment added: "+PropertiesUtil.getProperty("mail.attachmentFileName"));
			}

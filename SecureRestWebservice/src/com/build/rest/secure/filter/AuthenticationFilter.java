...
public class AuthenticationFilter implements ContainerRequestFilter
{
   ...
   // private Response ACCESS_DENIED = Response.status(Response.Status.UNAUTHORIZED).entity("You cannot access this resource").build();
   // private Response ACCESS_FORBIDDEN = Response.status(Response.Status.FORBIDDEN).entity("Access blocked for all users !!").build();
    ...
    private boolean isUserAllowed(final String username, final String password, final Set<String> rolesSet)
    {
        ...
        if(username.equals("abc") && password.equals("password"))
        {

...
public class CakeTopperRecord implements Serializable{
	...
	public String toString() {
		return "CraftRecord [recordId=" + recordId + ", retailer=" + retailer
				+ ", orderDate=" + orderDate + ", orderNo=" + orderNo
				+ ", item=" + item + ", itemType=" + itemType + ", color="
				+ color + ", itemDesc=" + itemDesc + ", customization="
				+ customization + ", userName=" + shippingUser + ", quantity="
				+ quantity + ", shippingCharge=" + shippingCharge
				+ ", makingCharge=" + makingCharge + ", shipped=" + shipped
				+ ", paid=" + paid + ", taskCompleted=" + taskCompleted
				+ ", shippingMode=" + shippingMode + ", shippingBatchNo="
				+ shippingBatchNo + "]";
	}
